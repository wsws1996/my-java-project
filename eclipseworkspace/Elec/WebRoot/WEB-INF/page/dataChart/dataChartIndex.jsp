		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					所属单位：</td>
					<td class="ta_01" >
						<s:select list="#request.jctList" name="projId" id="projId" listKey="ddlCode" listValue="ddlName" headerKey="" headerValue="全部" cssStyle="width:160px"></s:select>
					...
					<td class="ta_01" >
						 <font face="宋体" color="red"> 
					  	<s:select list="#request.picList" name="belongTo" id="belongTo" listKey="ddlCode" listValue="ddlName" headerKey="" headerValue="全部" cssStyle="width:160px"></s:select>
