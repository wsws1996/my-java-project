...
public class ExclusiveGatewayTest {
	...
	public void deployProgress() {
		...
		String resourceName_bpmn = "purchasingflow06.bpmn";

		InputStream inputStream_bpmn = this.getClass().getClassLoader()
				.getResourceAsStream("diagram/purchasingflow06.bpmn");

		String resourceName_png = "purchasingflow06.png";

		InputStream inputStream_png = this.getClass().getClassLoader()
				.getResourceAsStream("diagram/purchasingflow06.png");
