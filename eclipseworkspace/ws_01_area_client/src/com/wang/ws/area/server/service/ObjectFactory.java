 ...
 * generated in the com.wang.ws.area.server.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryAreaResponse_QNAME = new QName("http://service.server.area.ws.wang.com/", "queryAreaResponse");
    private final static QName _QueryArea_QNAME = new QName("http://service.server.area.ws.wang.com/", "queryArea");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wang.ws.area.server.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.area.ws.wang.com/", name = "queryAreaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.area.ws.wang.com/", name = "queryArea")
