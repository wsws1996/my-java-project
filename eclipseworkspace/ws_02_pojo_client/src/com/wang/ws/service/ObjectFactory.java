 ...
 * generated in the com.wang.ws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.ws.wang.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://service.ws.wang.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wang.ws.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.wang.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.wang.com/", name = "queryWeather")
