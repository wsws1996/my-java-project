 ...
 * generated in the com.wang.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://weather.wang.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://weather.wang.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wang.weather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather.wang.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather.wang.com/", name = "queryWeather")
