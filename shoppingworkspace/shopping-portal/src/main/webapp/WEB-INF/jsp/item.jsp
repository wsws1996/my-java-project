			...
			<ul id="choose" clstag="shangpin|keycount|product|choose">
				...
				<li id="choose-btns">
					<div id="choose-btn-append"  class="btn">
							...
							<a class="btn-append " id="InitCartUrl" onclick="addToCart()" clstag="shangpin|keycount|product|initcarturl">加入购物车<b></b></a> 
					</div>
...
<script type="text/javascript">
	function addToCart(){
		var num= $("#buy-num").val();
		location.href="/cart/add/${item.id}.html?num="+num;
	};
	var itemControl = {
			param:{
				descUrl:"/item/desc/",
