...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/shopping-logo.gif" alt="商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="王五"/>
		...
		<input type="hidden" name="orderShipping.receiverCity" value="新乡"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="牧野区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="河师大 xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">王五</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">河南 新乡市 牧野区</div>
						<div class="adr-m" limit="30">河师大 xxxxxxxxx</div>
