 ...
 */
function login() {
    return location.href = "http://sso.shopping.com/page/login";
}
function regist() {
    return location.href = "http://sso.shopping.com/page/register";
}
...
function search(a) {
    var b = "http://www.shopping.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
