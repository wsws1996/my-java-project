...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://manage.shopping.com/web/itemcat/all?callback=category.getDataService",
		URL_Serv: "http://rest.shopping.com/rest/itemcat/list?callback=category.getDataService",
//		URL_Serv: "http://www.shopping.com/category.json",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.shopping.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
