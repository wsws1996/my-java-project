...
<script language="javascript">
	...
	//用户：全部选中/不选中
	function checkAllUser(user) {
		$("input[type='checkbox'][name='selectuser']").attr("checked",
				user.checked);
	}
	//选中复选框，触发事件
			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="left" width="65%"><s:select
							...
							listKey="roleID" headerKey="0" headerValue="请选择"
							listValue="roleName" class="bg" cssStyle="width:180px"
							onchange="selectRole()">
						</s:select></td>
				</tr>
				<tr>
											...
											<s:iterator value="#request.popedomList">
												<tr onmouseover="this.style.backgroundColor = 'white'"
													...
													<td class="ta_01" align="left" width="18%" height="22"
														...
														type="checkbox" name="selectoper" id='<s:property value="mid"/>_<s:property value="mid"/>' value=""
