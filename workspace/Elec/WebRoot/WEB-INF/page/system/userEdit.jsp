...
<html>
 ...
 <body>
    ...
    <table cellSpacing="1" cellPadding="5" width="680" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
	 ...
	 <tr>
		<td class="ta_01" align="center" colSpan="4" background="${pageContext.request.contextPath }/images/b-info.gif">
		 <font face="宋体" size="2"><strong>	<s:if test="viewflag==null">
   		编辑用户
   	</s:if>
   	<s:else>
   		查看用户明细
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
		<s:select list="#request.sexList" name="sexID" id="sexID"  listKey="ddlCode" listValue="ddlName" headerKey="" headerValue="请选择" cssStyle="width:155px"></s:select>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">职位：<font color="#FF0000">*</font></td>
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.postList" name="postID" id="postID"  listKey="ddlCode" listValue="ddlName" headerKey="" headerValue="请选择" cssStyle="width:155px"></s:select>
		</td>
	</tr>
	<tr>
		<td align="center" bgColor="#f5fafe" class="ta_01">所属单位：<font color="#FF0000">*</font></td>
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.jctList" name="jctID" id="jctID"  listKey="ddlCode" listValue="ddlName" cssStyle="width:155px" onchange="findJctUnit(this)"></s:select>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">单位名称：<font color="#FF0000">*</font></td>
		<td class="ta_01" bgColor="#ffffff">
		<s:select list="#request.jctUnitList" name="jctUnitID" id="jctUnitID"  listKey="ddlCode" listValue="ddlName" cssStyle="width:155px" ></s:select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.isDutyList" name="isDuty" id="isDuty"  listKey="ddlCode" listValue="ddlName" cssStyle="width:155px"></s:select>
		</td>
	</tr>
	...
	<tr>
		...
		<s:textfield name="onDutyDate" value="%{onDutyDateDate}" id="onDutyDate" maxlength="50" size="20" onClick="WdatePicker()"></s:textfield>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">离职日期：</td>
		<td class="ta_01" bgColor="#ffffff">
		<s:date name="offDutyDate" format="yyyy-MM-dd" var="offDutyDateDate"/>
		<s:textfield name="offDutyDate" value="%{offDutyDateDate}" id="offDutyDate" maxlength="50" size="20" onClick="WdatePicker()"></s:textfield>
		</td>
	</tr>
