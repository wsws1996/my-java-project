			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="right"><input
						...
						id="BT_Add" type="button" value="查询" name="BT_find"
						onclick="gotoquery('elecUserAction_home.do')">&nbsp;&nbsp; <input
						style="font-size:12px; color:black; height=20;width=80"
						id="BT_Add" type="button" value="添加用户" name="BT_Add"
						...
						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Export" type="button" value="导出设置" name="BT_Export" 
						 ...
						 onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_chartUserFCF.do','700','400')">&nbsp;&nbsp;
						 </td>
				</tr>
								...
								<s:iterator value="#request.userList">
									<tr onmouseover="this.style.backgroundColor = 'white'"
										...
										<td align="center" style="HEIGHT: 22px" align="center"
											width="10%"><a href="#"
											onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=<s:property value="userID"/>','900','700');">
												<img
										...
										<td align="center" style="HEIGHT: 22px" align="center"
											width="10%"><a href="#"
											onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=<s:property value="userID"/>&viewflag=1','900','700');">
												<img
