...
public class ElecSystemDDL implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * ElecSystemDDL Namespace URI = http://domain.elec.wang.org/xsd Namespace
	 * Prefix = ns1
	 */
	...
	/**
	 * field for Itemname This was an Array!
	 */
	...
	public void addItemname(java.lang.String param) {
		...
		list.add(param);
		this.localItemname = (java.lang.String[]) list
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			java.lang.String namespacePrefix = registerPrefix(xmlWriter,
					"http://domain.elec.wang.org/xsd");
			if ((namespacePrefix != null)
					&& (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":ElecSystemDDL", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ElecSystemDDL", xmlWriter);
			}
			...
			if (localItemname != null) {
				...
				for (int i = 0; i < localItemname.length; i++) {
					...
					if (localItemname[i] != null) {
						...
						writeStartElement(null, namespace, "itemname",
								xmlWriter);

						xmlWriter
								.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
										.convertToString(localItemname[i]));
				...
				// write null attribute
				writeStartElement(null, "http://domain.elec.wang.org/xsd",
						"itemname", xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ElecSystemDDL parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ElecSystemDDL object = new ElecSystemDDL();
			...
			try {
						...
						if (!"ElecSystemDDL".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ElecSystemDDL) org.wang.elec.domain.xsd.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://domain.elec.wang.org/xsd", "ddlCode")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "ddlCode")
								.equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setDdlCode(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://domain.elec.wang.org/xsd", "ddlName")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "ddlName")
								.equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setDdlName(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://domain.elec.wang.org/xsd", "itemname")
								.equals(reader.getName())
					...
					object.setItemname((java.lang.String[]) list3
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://domain.elec.wang.org/xsd", "keyword")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "keyword")
								.equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setKeyword(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://domain.elec.wang.org/xsd",
								"keywordname").equals(reader.getName())
						|| new javax.xml.namespace.QName("", "keywordname")
								.equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setKeywordname(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://domain.elec.wang.org/xsd", "seqID")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "seqID")
								.equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setSeqID(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToInt(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://domain.elec.wang.org/xsd", "typeflag")
								.equals(reader.getName())
						|| new javax.xml.namespace.QName("", "typeflag")
								.equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setTypeflag(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
