...
<HTML>
	<HEAD>
     ...
     function saveWebServiceDict(){
	      document.Form2.action="${pageContext.request.contextPath }/system/elecSystemDDLAction_saveWebService.do";
	      document.Form2.submit();     
	} 
		...
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				...
				<TR height=10><td colspan=3 align="right">
				   ...
				   <input type="button" name="saveDict" value="同步总部数据字典" style="font-size:12px; color:black; height=20;width=80" onClick="saveWebServiceDict()">
				 </td></TR>   
			</TBODY>
		</table>
		</Form>
