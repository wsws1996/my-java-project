...
<HTML>
	...
	<s:debug></s:debug>
		<br>
		<s:form id="Form1" name="Form1" action="search" namespace="/user">
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff">
										<s:select list="#{'male':'男','female':'女' }" headerKey="" headerValue="--选择性别--" name="sex" id="sex"></s:select>
								...
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff">
										<s:select list="#{'true':'有','false':'无'}" headerKey="" headerValue="--请选择--" name="isUpload" id="isUpload"></s:select>
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator value="users">
										...
										<s:property value="telephone"/>		
											...
											<td align="center" style="HEIGHT: 22px">
											<s:a action="view" namespace="/user">
											<s:param name="userID" value="userID"></s:param>
											...
											<td align="center" style="HEIGHT: 22px">
											<s:a action="del" namespace="/user">
													<img src="${pageContext.request.contextPath}/images/i_del.gif" width="16" height="16" border="0" style="CURSOR: hand">
					<s:param name="userID" value="userID"></s:param>								</s:a>
