 ...
 * generated in the com.wang.ws.jaxws.weather.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.weather.jaxws.ws.wang.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.weather.jaxws.ws.wang.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wang.ws.jaxws.weather.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.weather.jaxws.ws.wang.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.weather.jaxws.ws.wang.com/", name = "queryWeatherResponse")
